...
combustivel = str(input("Digite op tipo de combustivel (A - Alcool/G - Gasolina): "))
...
match combustivel:
    case 'A':
        if litros <= 25: 
            ...
            print(f"O desconto é 2%, total a pagar é: {valor:.2f}")
        if litros > 25:
    ...
    case'G':
        if litros <= 25:
            ...
            print(f"O descon é de 3%, total a pagar é: {valor:.2f}")
        if litros > 25: 
